...
const showCredits = () => {
    console.log(`
    \x1b[32m
    hgmm1234x tarafından yapılmıştır hgmm1234x
    \x1b[0m`); 
};



process.title = 'Hgmm Server Nuker [v2.0] By hgmm1234x';
const showAsciiArt = () => {
    console.clear();
    console.log(`
    \x1b[31m

    hgmm Server Nuker [v2.0] By hgmm1234x                                            
    \x1b[0m`); 
};
...
const showLoadingScreen = () => {
    ...
    const text = "Developed by hgmm1234x";
    const colors = [
        "\x1b[38;2;0;123;255m",   
        "\x1b[38;2;0;255;255m",  
        "\x1b[38;2;0;255;123m",   
